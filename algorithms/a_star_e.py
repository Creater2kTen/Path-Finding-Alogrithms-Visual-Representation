...
from algorithms.heuristics import h2
import time
import pygame
...
def algorithm(start, end, grid, draw, win):
    ...
    f_score[start] = h2(start.get_position(), end.get_position())
    ...
    while not frontier.empty():
        ...
        for neighbour in current_node.neighbours:
            ...
            if next_g_score < g_score[neighbour]:
                ...
                f_score[neighbour] = next_g_score + h2(neighbour.get_position(), end.get_position()) + neighbour.weight
